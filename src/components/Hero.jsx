  ...
  return (
    ...
    >
      ...
      <div className="relative h-full flex flex-col items-center justify-center text-center px-6">
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-y-2 gap-x-3 sm:gap-6 px-4 sm:px-6 py-2 rounded-full bg-teal-950/60 border border-white/10 backdrop-blur-md text-paper/85 text-[11px] sm:text-xs shadow-inner max-w-[calc(100vw-2rem)]">
          <span className="whitespace-nowrap">
            <strong className="text-amber-300 font-display text-sm sm:text-base mr-1">6+</strong>
            tahun praktik
          </span>
          <span className="w-px h-3 bg-white/20" />
          <span className="whitespace-nowrap">
            <strong className="text-amber-300 font-display text-sm sm:text-base mr-1">1.000+</strong>
            pasien
          </span>
          <span className="w-px h-3 bg-white/20" />
          <span className="whitespace-nowrap">
            <strong className="text-amber-300 font-display text-sm sm:text-base mr-1">4.0</strong>
            rating
          </span>
        </div>
