...
const slides = [
  {
    ...
    // Titik fokus crop untuk video ini. Ubah kalau subjeknya
    // ke-crop kurang pas di layar sempit/lebar, mis. "center 20%".
    position: "center",
  },
  {
...
export default function Hero() {
  ...
  return (
    <section
      id="top"
      className="hero-viewport relative overflow-hidden bg-teal-900"
      onMouseEnter={() => setPaused(true)}
      onMouseLeave={() => setPaused(false)}
    >
      {/* full-bleed video background — always fills the section box
          exactly (w-full h-full object-cover), regardless of the
          video file's native resolution or aspect ratio. */}
